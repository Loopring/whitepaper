...
% \draw [draw, ->]  (relay2) -- (account5) [label]{};
 \draw [draw, dotted, thick]  (relay1) to node [auto, scale=0.7] {share liquidity}  (relay2) [label]{};
...
\node [steps, below of=relay2, xshift=0.3cm, yshift=-0.8cm] () {4};
\node [steps, right of=account3, xshift=-0.6cm] (step5) {5};

 \draw [bend right]  (psc) to node [auto, scale=0.7] {settle} (step5) [label]{};
 
\end{tikzpicture}

\caption{Exchange Process}
\label{fig:process}
\end{figurehere}
\end{center}
