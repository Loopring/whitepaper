...
% protocol_interface
\node [comment, right=0.25 of protocol_interface] {- Defines interfaces and events};

% tokenregistry
\node [comment, below=0.25 of tokenregistry] {- Registers ERC20/ERC223 tokens};

% delegate
\node [comment, below=0.25 of delegate] {- Makes token transfers on behalf of users};

% PUBLIC POLICIES
\node [comment, text width=3cm, below=0.25 of multisig] { - Enables multi-sigature ownership};

%%%%%%%%%%%%%%%%

% Draw the links between forces
\path[->,thick] 
(protocol_interface) edge (impl)
