...
%		text width=5cm,
 ...
 \draw [draw,->] (order1) -- node [label, xshift=-2.4cm] {\textbf{7898 tokenA}} (order5);
 \draw [draw,->] (order2) -| node [label, xshift=-1.8cm] {\textbf{8 tokenB}} (order1);
 \draw [draw,->] (order3) |- node [label, xshift=1cm, yshift=0.24cm] {\textbf{98 tokenC}} (order2);
 \draw [draw,->] (order4) -- node [label, xshift=2cm] {\textbf{98 tokenC}} (order3);
 \draw [draw,->] (order5) -- node [label, yshift=0.24cm] {\textbf{98 tokenC}} (order4);
