...
%		text width=5cm,
 ...
 \node [role, below of=user3] (relay1)  {Relay M};
 \node [role, below of=relay1] (relay2)  {Relay N};
...
\node [order, dashed, below of=relay2,xshift=-2cm] (order11) 
 {%
 \begin{tabular}{l}
  \textbf{ORDER 1}\\
  \textbf{owner: X}\\
...
xshift=0.1cm,
minimum width=1.8cm,
minimum height=11cm] (blockchain) {};
% blockchain accounts
  \node [account, right of=user1, xshift=1cm] (account1)  {accnt X};
  \node [account, right of=user2, xshift=1cm] (account2)  {accnt Y};
  \node [account, right of=user3, xshift=1cm] (account3)  {accnt Z};
  \node [account, right of=relay1, xshift=1cm] (account4)  {accnt M};
  \node [account, right of=relay2, xshift=1cm] (account5)  {accnt N};
 ...
 \draw [draw, <->, dashed]  (relay1) -- (relay2) [label]{};
 \draw [draw, ->]  (relay1) -- (ring) [label]{};
 \draw [draw, ->]  (relay2) -- (ring) [label]{};
 \draw [draw, ->]  (ring) -- (psc) [label]{};
