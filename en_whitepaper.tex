...
\begin{definition}[P2P Order]If the order’s tokenSFeePercentageor tokenBFeePercentageis greater than zero, the order is a P2P order. Other fee parameters in the P2P order will be ignored by the protocol.
\end{definition}
