...
% \draw [draw, ->]  (relay2) -- (account5) [label]{};
 \draw [draw, double, thick]  (relay1) to node [auto, scale=0.7] {Compartilhando Liquidez}  (relay2) [label]{};
...
\node [steps, right of=account3, xshift=-0.6cm] (step5) {6};
 ...
 \draw [bend right, ->]  (psc) to node [auto, scale=0.7, xshift=0.5cm] {liquidação} (step5) [label]{};
 
\end{tikzpicture}

\caption{Processo de Troca de Tokens Loopring}
\label{fig:process}
\end{figurehere}
\end{center}
