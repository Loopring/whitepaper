...
Esto es de cero-riesgo, cero-valor a\~nadido a la red, y se considera una conducta injusta por parte del minero de anillos. Para prevenir esto, Loopring requiere que un bucle v\'alido no pueda contener ning\'un sub-ring. Para verificar esto, los LPSC aseguran que un token no pueda estar en una posici\'on de compra o venta dos veces. En el diagrama anterior, podemos ver que el token \verb|A| es un token de venta dos veces y un token de compra dos veces, lo que no ser\'ia permitido.
